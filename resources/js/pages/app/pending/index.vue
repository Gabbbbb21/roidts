                        ...
                        <div v-for="request in requests" :key="request.id"
                            ...
                            <div class="p-6 w-full space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 text-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="col-span-full">
                                        <p class="text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Notes</p>
                                        <p
                ...
                <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl">
                    ...
                    <form @submit.prevent="forward()" class="p-6 md:p-8">
                        ...
                        <button type="submit"
                            ...
                            <svg class="me-2 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l4.532-2.311a1 1 0 00.569-.997V11a1 1 0 112 0v5.529a1 1 0 00.569.997l4.532 2.311a1 1 0 001.169-1.409l-7-14z"></path>
                            </svg>
                            Confirm Forward
                        </button>
                    </form>

                        ...
                        <tr v-for="request in requests" :key="request.id" @click="loadHistory(request.id)" :class="[
                            ...
                            <td class="px-6 py-4">
                                <form @submit.prevent="accept()">
                                    <button type="submit" @click="setCurrrentRequest(request.request_id)"
                                        class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Accept
                                    </button>
...
export default {
    ...
    methods: {
        ...
        accept() {
            // this.form.put(route("incoming.accept", { request: this.acceptRequestForm.request_id, }),)
            if (!this.form.request_id) {
                console.error("No request ID set for forwarding.");
                return;
            }
